var Desktop = (function() {
    ...
    function body_onmousemove() {
        //by fj 2011-4-1  关闭闪烁功能
        Core.Utility.StopScrollTitle();
        if (_moveVar != null) {
//            var name = _moveVar.Data.Window.GetTitle().substring(0, _moveVar.Data.Window.GetTitle().indexOf("("));
...
var Taskbar = (function() {
    ...
    obj.Resize = function() {
        ...
        //by  wenjl 2011-3-17  9:35 update 300 as 280
        var width = Math.round((Desktop.GetWidth() - 280) / 156 - 0.5) * 156 + 4;
        if (width < 0) width = 0;
    ...
    obj.Create = function() {
        ...
        //"<div class='icon'></div>" +    //by  wenjl 2011-3-17  9:35 delete icon class
			"<div></div>" +
			...
			"<div class='logout_button' style='display:none;'>[<a href='{0}'>退出</a>]</div>",
			Core.GetPageUrl('Signout.aspx')
		);
    ...
    function TaskbarItem(win) {
        ...
        dom.onclick = function() {
            //by fj 2011-4-1  关闭闪烁功能
//            var name = win.GetTitle().substring(0, win.GetTitle().indexOf("("));
//            if (document.title.indexOf(name) != -1) {
//                Core.Utility.StopScrollTitle();
//            }
            if (win.IsVisible()) {
