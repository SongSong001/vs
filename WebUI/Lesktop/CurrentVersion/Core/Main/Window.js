...
//					        var name = This.GetTitle().substring(0, This.GetTitle().indexOf("("));
...
//					        }
        ...
        This.Notify = function() {
            if (m_Task != null) m_Task.Shine(true);
        }
	...
	"<div style='display:none; z-Index:5;' class='waiting'></div>";
        ...
        var bk = new WindowBkImage({ Css: "background", Horiz: [6, 100, 6], Vertical: [24, 100, 6] });
