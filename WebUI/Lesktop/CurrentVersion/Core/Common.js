        ...
        try {
            if (m_ScrollTitleInternal != null) {
                ...
                if (Core.Session != undefined) {
                    if (Core.Session.GetUserName() == "" || Core.Session.GetUserName() == null) document.title = "";
                            ...
                            case 200:
                                {
                                    ...
                                    if (request.responseText != "")
                                        ...
                                        handler.onerror("Ajax请求错误", "服务器连接不上!");
                                    break;
                                }
                            default:
                                {
