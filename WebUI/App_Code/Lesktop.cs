			...
			case "Create":
				{
                    ...
                    String code = String.Format(@"{0}\Lesktop\{2}\Module\{1}.js", baseDirectory, path, Core.ServerImpl.Instance.ResPath);
                    String css = String.Format(@"{0}\Lesktop\{2}\Themes\Default\{1}.css", baseDirectory, path, Core.ServerImpl.Instance.ResPath);
