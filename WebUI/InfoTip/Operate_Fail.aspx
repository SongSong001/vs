<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Operate_Fail.aspx.cs" Inherits="WC.WebUI.InfoTip.Operate_Fail" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML xmlns:v>
<head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>系统提示 - 对不起，操作失败!</title>
...
cellPadding=0 width="100%">
  ...
  <TR>
    ...
    <img src="../img/info_fail.jpg" />
    </TD>
    <TD style="PADDING-TOP: 17px" vAlign=top>
    <ul>
    <li>对不起！您的本次操作失败!</li>
    <li>本次操作错误信息将记录在系统日志中</li>
    <li><%=times %>秒内将自动返回系统</li>
    </ul>
      <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A href=<%=return_page %> ><strong>返回系统</strong></A>
