...
{
    public partial class Gov_ModelList : WC.BLL.ModulePages
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Gov_ModelList.aspx" + url);
        }
        ...
        protected void Del_Btn(object obj, EventArgs e)
        {
            ...
            string sql0 = "delete from Gov_Model where id=" + rid;
            string sql = "delete from Gov_ModelStep where Flow_ModelID=" + rid;
        ...
        private void Show()
        {
            ...
            IList list = Gov_Model.Init().GetAll(where, "order by id desc");
