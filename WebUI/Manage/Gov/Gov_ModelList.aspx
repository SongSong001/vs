<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gov_ModelList.aspx.cs" Inherits="WC.WebUI.Manage.Gov.Gov_ModelList" %>
<%@ Register Src="~/Controls/Page.ascx" TagName="Page" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>公文模型列表</title>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td> 
	  <a href="Gov_ModelList.aspx">公文模型列表</a>
	  </td>
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td class="vtip" title='<%# !string.IsNullOrEmpty(Eval("namelist")+"") ? Eval("namelist")+"":"所有部门" %>'>
		...
		<td class="manage">
			<a href=Gov_ModelManage.aspx?fm=<%#Eval("id") %> class="show">编辑</a>
			<a href=Gov_Graph.aspx?fm=<%#Eval("id") %> target=_blank class="show">图例</a>
