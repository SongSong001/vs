<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GovType_Manage.aspx.cs" Inherits="WC.WebUI.Manage.Gov.GovType_Manage" %>
...
<body >
  ...
  <div id="interface_quick">
    <div class="interface_quick_left">您现在的操作 >> 公文管理 >> 添加模型分类</div>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
	  <a href="GovType_Manage.aspx">添加模型分类</a>
	  </td>
