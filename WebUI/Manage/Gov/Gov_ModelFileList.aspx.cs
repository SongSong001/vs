...
{
    public partial class Gov_ModelFileList : WC.BLL.ModulePages
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Gov_ModelFileList.aspx" + url);
        }
        ...
        protected void Del_Btn(object obj, EventArgs e)
        {
            ...
            Gov_ModelFile.Init().Delete(rid);
            string sql = "update Gov_Model set ModelFileID='0' where ModelFileID='" + rid + "'";
        ...
        private void Show()
        {
            ...
            IList list = Gov_ModelFile.Init().GetAll(where, "order by id desc");
