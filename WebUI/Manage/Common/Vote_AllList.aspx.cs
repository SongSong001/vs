...
{
    public partial class Vote_AllList : WC.BLL.ModulePages
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Vote_AllList.aspx" + url);
        }
        ...
        protected void Del_Btn(object obj, EventArgs e)
        {
            ...
            if (p.Visible == true)
            {
                ...
                Response.Redirect("Vote_AllList.aspx");
            }
        }
