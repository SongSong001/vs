<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vote_AllList.aspx.cs" Inherits="WC.WebUI.Manage.Common.Vote_AllList" %>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
<a href="Vote_AllList.aspx">所有投票管理</a>
	  </td>
 ...
 <asp:Repeater runat=server ID=rpt OnItemDataBound=RowDataBind><ItemTemplate>
	<tr>
		...
		<td class="manage">
			...
			<a href=Vote_UserList.aspx?vid=<%#Eval("id") %> class="show" target=_blank>选票</a>
		</td>
	</tr>
