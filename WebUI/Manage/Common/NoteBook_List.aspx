<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoteBook_List.aspx.cs" Inherits="WC.WebUI.Manage.Common.NoteBook_List" %>
<%@ Register Src="~/Controls/Page.ascx" TagName="Page" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>记事便笺列表</title>
...
<div id="interface_inside">
  <div id="interface_quick">
    <div class="interface_quick_left">您现在的操作 >> 我的工具 >> 记事便笺</div>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td style="font-weight:bold;">
			<a href=NoteBook_Manage.aspx?nid=<%#Eval("id") %> ><%#Eval("Subject")%></a>
		</td>	
		<td>
		<%# WC.Tool.Utils.ConvertDate2(Eval("AddTime")) %>
		</td>
		<td class="manage">
			<a href=NoteBook_Manage.aspx?nid=<%#Eval("id") %> class="show">编辑</a>
			<a href=Mail_Manage.aspx?notebook=<%#Eval("id") %> class="show">发送</a>
