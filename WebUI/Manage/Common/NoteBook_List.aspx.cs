...
{
    public partial class NoteBook_List : WC.BLL.ViewPages
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("NoteBook_List.aspx" + url);
        }
        ...
        protected void Del_Btn(object obj, EventArgs e)
        {
            ...
            WC.BLL.NoteBook.Init().Delete(rid);
            Show();
        }
