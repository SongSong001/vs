<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalendarMemo.aspx.cs" Inherits="WC.WebUI.Manage.CalendarMemo.CalendarMemo" %>
...
var _loadStartTime=_gt(),_user_email="admins@job18.net",_nav=navigator.userAgent.toLowerCase(),_tsf=141;
...
<link type="text/css" rel="stylesheet" href="6a3eb8ba4a07edb76f79a18d6bdb8933doozercompiled.css">
<script type="text/javascript" src="6a3eb8ba4a07edb76f79a18d6bdb8933calendarjs_doozercompiled__zh_cn.js"></script>
...
function postRender() {
 ...
 var rt_clientDispatches = [['_DS_put', '<%=memo %>', 70, 0, 0, '我的日程安排', 'Asia/Shanghai', null, null, null, 'a7fb62e329d482a056dd42a629610e57', ['<%=memo %>', 70], null, '', 'admins@job18.net', 'CN', 'add', null, null, '(GMT+08:00) 中国时间 - 北京', [], [], null, null, 0, 1, null], ['_SE_refreshAddCalendarView'], ['ap', ['<%=memo %>', 0, '我的日程安排', 'admins@job18.net']],
 ['_RedrawCheckboxes'],
 ['ap', ['<%=memo %>', 0, '我的日程安排', 'admins@job18.net', '<%=memo %>', 2, '我的日程安排', 'admins@job18.net']],
 ['sb', '<%=memo %>', 1, 3, 600],
