...
{
    public partial class Role_List : WC.BLL.ModulePages
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Role_List.aspx" + url);
        }
        ...
        protected void Del_Btn(object obj, EventArgs e)
        {
            ...
            string sql = "delete from Sys_Role_Module where RoleID=" + rid;
            MsSqlOperate.ExecuteNonQuery(CommandType.Text, sql, null);
            Sys_Role.Init().Delete(rid);
            Show();
        }
