...
<script type="text/javascript">
    function personView(ud) {
        ...
        pop.setContent("contentUrl", '/manage/Sys/User_View.aspx?type=1&uid=' + ud);
...
<thead>
	<tr>
		...
		<td width="30"><span style="margin-left:7px;">ID</span></td>
			<td width="80">用户名</td>
			<td width="80">真实姓名</td>
			<td width="140">职能部门</td>
			<td width="35">性别</td>
			<td width="95">生日</td>
			<td width="50">状态</td>
			<td width="215">管理</td>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td class="manage">
            <%--<a href='HR_View.aspx?uid=<%#Eval("id") %>' target=_blank class="show">查看</a>--%>
            <a href='HR_View.aspx?uid=<%#Eval("id") %>' target=_blank class="show">查看</a>
			<a href=User_Manage.aspx?uid=<%#Eval("id") %> class="show">编辑用户</a>
            <a href=HR_Manage.aspx?uid=<%#Eval("id") %> class="show">编辑人事</a>
