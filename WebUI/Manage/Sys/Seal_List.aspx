<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seal_List.aspx.cs" Inherits="WC.WebUI.Manage.Sys.Seal_List" %>
<%@ Register Src="~/Controls/Page.ascx" TagName="Page" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>印章/签名列表</title>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
	  <a href="Seal_List.aspx">印章签名列表</a>
	  </td>
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td>
			<%# WC.Tool.Utils.GetStringByInt(Convert.ToInt32(Eval("Status")))%>
		</td>
		<td class="manage">
			<a href=Seal_Manage.aspx?mid=<%#Eval("id") %> class="show">编辑</a>
