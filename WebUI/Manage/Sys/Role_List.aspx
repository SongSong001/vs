<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Role_List.aspx.cs" Inherits="WC.WebUI.Manage.Sys.Role_List" %>
<%@ Register Src="~/Controls/Page.ascx" TagName="Page" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>用户角色列表</title>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
	  <a href="Role_List.aspx">用户角色列表</a>
	  </td>
...
<thead>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<%# WC.Tool.Utils.GetSubString(Eval("Notes") + "", 35, "..") %>
		</td>
		<td class="manage">
			<a href=Role_Manage.aspx?rid=<%#Eval("id") %> class="show">编辑</a>
