...
{
    public partial class Flow_ModelFileList : WC.BLL.ModulePages
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Flow_ModelFileList.aspx" + url);
        }
        ...
        protected void Del_Btn(object obj, EventArgs e)
        {
            ...
            Flows_ModelFile.Init().Delete(rid);
            string sql = "update Flows_Model set ModelFileID='0' where ModelFileID='" + rid + "'";
        ...
        private void Show()
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["keywords"]))
                where += " and (FormTitle like '%" + Request.QueryString["keywords"]
                    + "%' or FilePath like '%" + Request.QueryString["keywords"] + "%')";

            IList list = Flows_ModelFile.Init().GetAll(where, "order by id desc");
