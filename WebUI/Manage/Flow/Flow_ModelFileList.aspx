<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flow_ModelFileList.aspx.cs" Inherits="WC.WebUI.Manage.Flow.Flow_ModelFileList" %>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
	  <a href="Flow_ModelFileList.aspx">模板表单列表</a>  
	  </td>
...
<thead>
	<tr>
		...
		<td width="140"><span style="margin-left:25px;">序</span></td>
 ...
 <asp:Repeater runat=server ID=rpt><ItemTemplate>
	<tr>
		...
		<td class="manage">
			<a href=Flow_ModelFileManage.aspx?fmf=<%#Eval("id") %> class="show">编辑</a>
