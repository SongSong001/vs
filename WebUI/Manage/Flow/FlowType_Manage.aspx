<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowType_Manage.aspx.cs" Inherits="WC.WebUI.Manage.Flow.FlowType_Manage" %>
...
<body >
  ...
  <div id="interface_quick">
    <div class="interface_quick_left">您现在的操作 >> 流程管理 >> 添加模型分类</div>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
	  <a href="FlowType_Manage.aspx">添加模型分类</a>
	  </td>
