...
{
    public partial class PaperList : WC.BLL.ViewPages
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("PaperList.aspx" + url);
        }
        ...
        private void Show()
        {
                ...
                || !string.IsNullOrEmpty(Request.QueryString["EndTime"]))
            {
                ...
                string where = " 1=1 and (ShareDeps='' or ShareDeps like '%#" + DepID + "#%') ";
            ...
            else
            {
                if (Request.QueryString["td"] != null)
                    list = WC.BLL.Paper.Init().GetAll("TypeID=" + Request.QueryString["td"], "order by id desc");
                else
            ...
            {
                if (Request.QueryString["td"] != null)
                    this.Page1.sty("meneame", pagecount, pds.PageCount, "?td=" + Request.QueryString["td"] + "&page=");
                else
