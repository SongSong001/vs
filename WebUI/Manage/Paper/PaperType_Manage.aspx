<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaperType_Manage.aspx.cs" Inherits="WC.WebUI.Manage.Paper.PaperType_Manage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/><title>档案分类</title>
...
<body >
  ...
  <div id="interface_quick">
    <div class="interface_quick_left">您现在的操作 >> 电子档案 >> 添加档案分类</div>
...
<table class="table subsubmenu">
  <thead>
	<tr>
	  <td>
	  <a href="PaperType_Manage.aspx">添加档案分类</a>
	  </td>
