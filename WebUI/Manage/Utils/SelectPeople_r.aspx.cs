...
{
    public partial class SelectPeople_r : WC.BLL.ViewPages
    {
        protected string bj = "";
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            string url = "?keywords=" + HttpContext.Current.Server.HtmlEncode(keywords.Trim()) + "&obj=" + Request.QueryString["obj"];
            if (!string.IsNullOrEmpty(Request.QueryString["v"]))
