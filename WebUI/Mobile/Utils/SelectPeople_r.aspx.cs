...
{
    public partial class SelectPeople_r : WC.BLL.MobilePage
    {
        ...
        protected void Search_Btn(object sender, EventArgs e)
        {
            ...
            Response.Redirect("SelectPeople_r.aspx" + url);
        }

        private void Show()
        {
            IList alllist = Sys_User.Init().GetAll("Status=0 and IsLock=0 ", "order by depid,orders asc");
            ...
            IList list = Sys_User.Init().GetAll("Status=0 and IsLock=0", "order by depid,orders asc");
