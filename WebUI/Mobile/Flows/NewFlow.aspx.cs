...
{
    public partial class NewFlow : WC.BLL.MobilePage
    {
        ...
        protected void Save_Btn(object sender, EventArgs e)
        {
            if (rpt_steps.Items.Count > 0)
            {
                ...
                if (valid)
                {
                    ...
                    WC.Tool.MessageBox.ShowAndRedirect(this, "新建工作流程成功!", "FlowMenu.aspx");
                }
                else
                {
                    //Response.Write("<script>alert('审批人员 不能为空!')</script>");
                    WC.Tool.MessageBox.ShowAndRedirect(this, "审批人员 不能为空!", "NewFlow.aspx");
                }
            ...
            else
            {
                ...
                WC.Tool.MessageBox.ShowAndRedirect(this, "工作流程没有审批步骤!", "NewFlow.aspx");
            }
        }
