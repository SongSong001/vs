<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppMenu.aspx.cs" Inherits="WC.WebUI.Mobile.GovApp.AppMenu" %>
...
<div class="list">
    <ul>
        ...
        <li>
            <a href="AppList.aspx?action=verify"><i class="icon icon_list7"></i>我的审批（<b><%=wdpy %></b>）</a>
        </li>
        <li>
            <a href="AppList.aspx?action=verified"><i class="icon icon_list8"></i>已经批阅（<%=yjpy %>）</a>
        </li>
        <li>
            <a href="AppList.aspx?action=apply"><i class="icon icon_list9"></i>我的发文（<%=wdsq %>）</a>
        </li>
         <li>
            <a href="NewGoaApp.aspx"><i class="icon icon_list9"></i>发文拟稿</a>
        </li>
    </ul>
</div>
        <div class="fix">
