...
{
    public partial class NewGoaApp : WC.BLL.MobilePage
    {
        ...
        protected void Save_Btn(object sender, EventArgs e)
        {
            if (rpt_steps.Items.Count > 0)
            {
                ...
                if (valid && userlist.Value.Contains(","))
                {
                    ...
                    WC.Tool.MessageBox.ShowAndRedirect(this, "发文拟稿成功!", "AppMenu.aspx");
                }
                else
                {
                    WC.Tool.MessageBox.ShowAndRedirect(this, "审批人员 不能为空!", "NewGoaApp.aspx");
                }
            }
            else
            {
