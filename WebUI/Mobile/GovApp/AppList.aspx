<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppList.aspx.cs" Inherits="WC.WebUI.Mobile.GovApp.AppList" %>
...
<body class="applist">
    ...
    <div class="searchbox">
        <form action='AppList.aspx?type=<%=Request.QueryString["action"] %>' method="post">
        <fieldset>
...
<form id="form1" runat="server">
    <div id="content">
        <ul>
            ...
            <li><a class="effect" href='AppView.aspx?fl=<%#Eval("id") %>'>
    ...
    <form id="form1" runat="server">
        <div class="user">
            <asp:Repeater runat="server" ID="rpt" EnableViewState="false">
                <ItemTemplate>
                    <dl>
                        <a href='AppView.aspx?fl=<%#Eval("id") %>'>

                            <dt>
                                <img alt="" src="../image/user.jpg" /></dt>
                            <dd>
                                <dd>
                                    <h4><%#Eval("CreatorRealName")%> (拟稿人)</h4>
