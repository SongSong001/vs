<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MailMenu.aspx.cs" Inherits="WC.WebUI.Mobile.Mails.MailMenu" %>
...
<body>
    ...
    <div class="list">
        <ul>
            ...
            <li>
                <a href="MailList.aspx?fid=0"><i class="icon icon_list11"></i>收件箱（<b runat="server" id="sjx">1/2</b>）</a>
            </li>
            <li>
                <a href="MailList.aspx?fid=1"><i class="icon icon_list12"></i>草稿箱（<%=cgx %>）</a>
            </li>
            <li>
                <a href="MailList.aspx?fid=2"><i class="icon icon_list13"></i>发件箱（<%=fjx %>）</a>
            </li>
            <li>
                <a href="MailList.aspx?fid=3"><i class="icon icon_list14"></i>垃圾箱（<%=ljx %>）</a>
            </li>
            <li>
                <a href="SendMail.aspx"><i class="icon icon_list15"></i>发送新邮件</a>
            </li>
        </ul>
    </div>
    <div class="fix">
