<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="WC.WebUI.Mobile.News.NewsList" %>
...
<body class="applist">
    ...
    <div class="searchbox">
        <form action='NewsList.aspx?type=<%=t %>' method="post">
        <fieldset>
...
<form id="form1" runat="server">
    <div id="content">
        <ul>
            ...
            <li><a class="effect" href='NewsView.aspx?nid=<%#Eval("id") %>'>
            <span class="image" style="background-image: url('../Style/Mobile/thumbs/otherapps.png')"></span>
                ...
                <span class="name">
                <%# WC.Tool.Utils.GetSubString2(Eval("NewsTitle") + "", 17, "..")%>
                </span> 
                <span class="stars4">
            ...
            <ul>
                <li>
                    <form action='NewsList.aspx?type=<%=t %>' method="post">
                        ...
                        <input runat="server"
                            name="keywords" id="keywords" placeholder="查找(标题/姓名)" type="text" />
    ...
    <form id="form1" runat="server">
        <div class="user">
            <asp:Repeater runat="server" ID="rpt" EnableViewState="false">
                <ItemTemplate>
                    <dl>
                        <a  href='NewsView.aspx?nid=<%#Eval("id") %>'>
                            
                            <dt>
                               <img alt="" src="../image/user.jpg" /></dt>
                            <dd>
                            <dd>
                                <h4><%#Eval("CreatorRealName")%></h4>
                                <p><%# WC.Tool.Utils.GetSubString2(Eval("NewsTitle") + "", 17, "..")%></p>
