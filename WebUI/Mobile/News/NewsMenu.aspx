<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsMenu.aspx.cs" Inherits="WC.WebUI.Mobile.News.NewsMenu" %>
...
<div class="list">
    <ul>
       ...
       <%-- <li>
            <a href="#"><i class="icon icon_list16"></i>所有资讯（0）</a>
        </li>
        <li>
            <a href="#"><i class="icon icon_list17"></i>通知公告（0）</a>
        </li>
        <li>
            <a href="#"><i class="icon icon_list18"></i>企业新闻（1）</a>
        </li>
        <li>
            <a href="#"><i class="icon icon_list19"></i>规章制度（0）</a>
        </li>
        <li>
            <a href="#"><i class="icon icon_list20"></i>公共资源（0）</a>
        </li>--%>
         <%=news_menu %>
    </ul>
</div>
<div class="fix">
    <ul>
        <li class="cur"><a href="javascript:;"><i class="icon information"></i><span>资讯</span></a></li>
