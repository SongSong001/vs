<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorkLog.aspx.cs" Inherits="WC.WebUI.Mobile.WorkLog.AddWorkLog" %>
...
<body>
    ...
    <div id="content">
        <fieldset>
            ...
            <ul class="pageitem">
                <li class="textbox">
                    <textarea runat="server" name="Bodys" id="Bodys" placeholder="汇报内容 (不能为空)" rows="15" style="width:100%;"></textarea>
                </li>
            </ul>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="list">
            <ul>
                ...
                <li>
                    <input runat="server" name="LogTitle" type="text" id="LogTitle" placeholder="汇报标题 (不能为空)" />
                </li>
                <li>
                    <h4>* 汇报日期：</h4>
                </li>
                <li>
                    <%--<label>* 汇报日期：</label>
                <input runat="server" readonly="readonly"  id="addTime" name="addTime" placeholder="汇报日期 (不能为空)" type="text" size="30" />--%>

                    <input runat="server" readonly="readonly"
                        id="addTime" name="addTime" placeholder="汇报日期 (不能为空)" type="text" size="30" />
                </li>
                <li>
                    <h4>接收人：</h4>
                </li>
