...
<div class="list">
    <ul>
        ...
        <li>
            <a href="FileList.aspx?action=mydoc"><i class="icon icon_list7"></i>我的文档（<b><%=num1 %></b>）</a>
        </li>
        <li>
            <a href="FileList.aspx?action=shared"><i class="icon icon_list8"></i>同事共享（<%=num2 %>）</a>
        </li>
        <li>
            <a href="UpdateFile.aspx"><i class="icon icon_list9"></i>新建上传</a>
        </li>
        ...
        <ul>
            ...
            <li class="cur"><a href="javascript:;"><i class="icon word"></i><span>文档</span></a></li>
