...
{
    public partial class UpdateFile : WC.BLL.MobilePage
    {
        ...
        {
            if (!string.IsNullOrEmpty(DocTitle.Value))
            {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["did"]))
                {
                    ...
                    WC.Tool.MessageBox.ShowAndRedirect(this, "保存成功!", "FileMenu.aspx");
                }
                else
                {
                    if (isfile != 0)
                    ...
                    {
                        WC.Tool.MessageBox.ShowAndRedirect(this, "您还没上传任何文件!", Request.Url.AbsoluteUri);
                    }
                }
            }
            else
            {
                WC.Tool.MessageBox.ShowAndRedirect(this, "标题不能为空!", Request.Url.AbsoluteUri);
            }
        }
