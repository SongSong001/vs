<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileList.aspx.cs" Inherits="WC.WebUI.Mobile.Files.FileList" %>
...
<body class="applist">
    ...
    <div class="searchbox">
        <form action='FileList.aspx?type=<%=Request.QueryString["action"] %>' method="post">
        <fieldset>
...
<form id="form1" runat="server">
    <div id="content">
        <ul>
            ...
            <li><a class="effect" href='FileView.aspx?did=<%#Eval("id") %>'>
            <span class="image" style="background-image: url('../Style/Mobile/thumbs/notepad.png')"></span>
                <span class="comment"><%#Eval("CreatorRealName")%> (上传者)</span> 
                <span class="name">
                <%# WC.Tool.Utils.GetSubString2(Eval("DocTitle") + "", 17, "..")%>
                </span> 
                <span class="stars4">
                <%# WC.Tool.Utils.ConvertDate5(Eval("AddTime"))%>
                </span>
    ...
    <form id="form1" runat="server">
        <div class="user">
            <asp:Repeater runat="server" ID="rpt" EnableViewState="false">
                <ItemTemplate>
                    <dl>
                        <a href='FileView.aspx?did=<%#Eval("id") %>'>

                            <dt>
                                <img alt="" src="../image/user.jpg" /></dt>
                            <dd>
                                <dd>
                                    <h4><%#Eval("CreatorRealName")%> (上传者)</h4>
                                    <p><%# WC.Tool.Utils.GetSubString2(Eval("DocTitle") + "", 17, "..")%></p>
                                    <span><%# WC.Tool.Utils.ConvertDate5(Eval("AddTime"))%></span>
                                </dd>
                        </a>
