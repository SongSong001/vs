<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateFile.aspx.cs" Inherits="WC.WebUI.Mobile.Files.UpdateFile" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowIframe() {
            ...
            pop.setContent("title", "上传文件 - 共享人员选择");
            pop.build();
            pop.show();
        }
...
<body>
    ...
    <div id="content">
        <fieldset>
            <span class="graytitle">* 文档标题：</span>
            <ul class="pageitem">
                <li class="bigfield">
                    <input runat=server name="DocTitle" type="text" id="DocTitle" placeholder="文件标题 (不能为空)" style="width:100%;" />
                </li>
            </ul>
            <span class="graytitle"> 文档分类：</span>
            <ul class="pageitem">
                <li class="bigfield">
                    <asp:DropDownList placeholder="点击选择文档分类" runat=server ID=doctype style="width:100%;" EnableViewState=false></asp:DropDownList>
                </li>
            </ul>
            <span class="graytitle"> 共享人员： </span>
            <ul class="pageitem">
                <li class="textbox">
                    <input runat=server type=hidden id=userlist name=userlist value="" />
                    <textarea runat=server type=text id=namelist name=namelist readonly=readonly placeholder="不共享可留空" rows=3 style="width:100%;"></textarea>
                </li>
                <li class="button" style="text-align: center;">
                <input type=button id=bt8 name=bt8 onclick=ShowIframe() value=' 选择人员 ' /></li>
            </ul>

            <span class="graytitle"> 文件备注：</span>
            <ul class="pageitem">
                <li class="textbox">
                    <textarea runat="server" name="Notes" id="Notes" placeholder="" rows="2" style="width:100%;"></textarea>
                </li>
            </ul>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="list">
            <ul>
                ...
                <li>
                    <input runat="server" name="DocTitle" type="text" id="DocTitle" placeholder="文档标题 (不能为空)" />
                </li>
                <li>
                    <h4>文档分类：</h4>
                </li>
        ...
        <div class="list">
            ...
            <div class="ina_edit">
                <textarea runat="server" name="Notes" id="Notes" placeholder="内容 (不能为空)" rows="15" style="width: 100%; height: 190px"></textarea>
            </div>
        </div>
        <div class="list">
            <ul>
