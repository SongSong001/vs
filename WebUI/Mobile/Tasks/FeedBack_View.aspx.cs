...
{
    public partial class FeedBack_View : WC.BLL.MobilePage
    {
        ...
        private void Show(string tid)
        {
            ...
            {
                WC.Tool.MessageBox.ShowAndRedirect(this, "您没有权限查看!", "TaskMenu.aspx");
            }
