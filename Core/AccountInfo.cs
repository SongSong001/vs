namespace Core
{
    ...
    public class AccountInfo : IRenderJson
    {
        ...
        public bool IsCreatedBy(string name)
        {
            lock (this.m_Lock)
            {
                return ((this.Type == 1) && (string.Compare(name, this.m_Creator.Name, true) == 0));
            }
        }
        ...
        public bool IsManagedBy(string name)
        {
            lock (this.m_Lock)
            {
                return ((this.Type == 1) && this.m_Managers.ContainsKey(name.ToUpper()));
            }
        }
        ...
        public long DiskSize
        {
            get
            {
                ...
                lock (this.m_Lock)
                {
                    return ((this.m_DiskSize * 0x400) * 0x400);
                }
            }
        }
