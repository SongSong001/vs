...
namespace WC.BLL
{
    ...
    {
        /// <summary>
        /// 在业务逻辑层中设置一个静态只读Flows_Step操作类的对象
        /// </summary>
        private static readonly IFlows_Step dal = WC.Factory.DALFactory.CreateFlows_StepDAL();

        /// <summary>
        /// 封装业务层中Flows_Step操作类的构造方法
        /// </summary>
        private Flows_Step() { }

        /// <summary>
        /// 业务逻辑层中Flows_Step操作类对象的静态生成方法
        /// </summary>
        /// <returns></returns>
